...
• Provides a reference to a table or a column starting with a "$" ($TableID or $TableID.ColumnID)`;t.configureOptions([WidgetSDK.newItem("columns",null,"Behavior","Configure the behavior of each columns","Columns",{columnId:"STATUT",template:[WidgetSDK.newItem("addbutton",!0,"Can add card","If checked, display a button to add card to the column."),WidgetSDK.newItem("isdone",!1,"Is done","If checked, cards in the columns are considered as over."),WidgetSDK.newItem("useconfetti",!1,"Use confetti","If checked, confetti apprear when a card enter in the column."),WidgetSDK.newItem("hidecolumn",!1,"Hide","If checked, the column is hidden.")]}),WidgetSDK.newItem("ref","","References","List of task references available.","Cards options",{description:a,columnId:"REFERENCE_PROJET",type:"lookup"}),WidgetSDK.newItem("types","","Type","List of task types available.","Cards options",{description:a,columnId:"TYPE",type:"lookup"}),WidgetSDK.newItem("incharge","","In charge","List of people that can be in charge of the task.","Cards options",{description:a,columnId:"RESPONSABLE",type:"lookup"}),WidgetSDK.newItem("cardcolor","","Card color","List of color available for card background.","Cards options",{description:a,columnId:"COULEUR",type:"lookup"}),WidgetSDK.newItem("rotation",!0,"Tilt","If checked, cards are randomly tilted.","Display"),WidgetSDK.newItem("compact",!1,"Compact","If checked, use a compact rendering.","Display"),WidgetSDK.newItem("readonly",!1,"Read only","If checked, kanban is ready only.","Display"),WidgetSDK.newItem("hideedit",!1,"Hide editing form","If checked, hide the editing form when click on a card.","Display"),WidgetSDK.newItem("gristeditcard",!1,"Grist Record Card","If checked, opens the grist record card on double click.","Display")],"#config-view","#main-view",{onOptChange:b,onOptLoad:b}),t.initMetaData(),t.ready({requiredAccess:"full",allowSelectBy:!0,columns:[{name:"STATUT",title:"Status",description:"Defines the Kanban column",type:"Choice",strictType:!0},{name:"DESCRIPTION",title:"Task",description:"Task name",type:"Any"},{name:"DESCRIPTION_DISPLAY",title:"Task Display",description:"Displayed card content (e.g. a formula column adding html)",type:"Any",optional:!0},{name:"DEADLINE",title:"Deadline",description:"Can also be use as priority",type:"Date",optional:!0},{name:"REFERENCE_PROJET",title:"Reference",description:"Reference associated with the task",type:"Any",optional:!0},{name:"TYPE",title:"Type",description:"Type associated with the task",type:"Any",optional:!0},{name:"RESPONSABLE",title:"Responsables",description:"Personnes responsables de la tâche",type:"RefList",strictType:!0,optional:!0},{name:"CREE_PAR",title:"Created by",type:"Any",optional:!0},{name:"CREE_LE",title:"Creation date",type:"DateTime",optional:!0},{name:"DERNIERE_MISE_A_JOUR",title:"Last update date",description:"Updated after any change",type:"DateTime",optional:!0},{name:"NOTES",title:"Notes",description:"Additional notes",type:"Any",optional:!0},{name:"COULEUR",title:"Card color",description:"Choice or html value",type:"Choice,Text",optional:!0},{name:"TAGS",title:"Tags",description:"Additional fields to display",type:"Any",optional:!0,allowMultiple:!0}]}),t.onRecords(v,{expandRefs:!1,keepEncoded:!1,mapRef:!0}),t.isLoaded().then(async()=>{t.initDone=!0}),grist.on("message",async n=>{n.mappingsChange&&L()})});async function v(e){I=e;const a=document.getElementById("conteneur-kanban");a.innerHTML="";const n=await t.col.STATUT.getChoices();if(!n||n.length===0){console.error(u("No choice available in the Status column"));return}let s;n.forEach((o,i)=>{s=$(o,i),s!=null&&a.appendChild(s)}),e?.length>0&&(e.forEach(o=>{const i=O(o),r=document.querySelector(`.contenu-colonne[data-statut="${o.STATUT}"]`);r&&r.insertBefore(i,r.firstChild)}),t.opt.readonly||document.querySelectorAll(".contenu-colonne").forEach(o=>{new Sortable(o,{group:"kanban-todo",animation:150,onEnd:async function(i){const r=i.to.dataset.statut;if(r===i.from.dataset.statut){if(t.map.DEADLINE){let l=i.item.dataset.deadline||"9999-12-31";if(i.oldIndex!==i.newIndex&&new Date(l)>=f){let E=f.getFullYear(),d=[];document.querySelectorAll(".contenu-colonne").forEach(c=>{c.getAttribute("data-statut")===r&&c.querySelectorAll(".carte").forEach(async p=>{l=p.getAttribute("data-deadline")||"9999-12-31",new Date(l)>=f&&(l=`${E}-01-01`,p.setAttribute("data-deadline",l),E+=1,d.push(t.formatRecord(p.getAttribute("data-todo-id"),{DEADLINE:l})))})});try{await t.updateRecords(d)}catch(c){console.error(u("Error during status update:"),c)}}}}else try{await A(i.item.dataset.todoId,"STATUT",r)}catch(l){console.error(u("Error during status update:"),l)}D(o)}}),D(o)}),document.querySelectorAll(".colonne-kanban").forEach(N))}async function b(e){await t.isMapped(),v(I)}function $(e,a){const n=t.opt.columns[a];if(n.hidecolumn)return null;const s=document.createElement("div");return s.className=`colonne-kanban${!n.addbutton&&!t.opt.compact?" colonne-nobouton":""}`,s.id=e,localStorage.getItem(`column-todo-${e}`)==="true"&&s.classList.add("collapsed"),s.innerHTML=`
    ...
    `,s}function L(){const e=document.getElementsByClassName("colonne-kanban");Array.prototype.forEach.call(e,a=>{a.style=`background-color: ${t.col.STATUT.getColor(a.id)??g};color:${t.col.STATUT.getTextColor(a.id)??R}`}),w()}async function w(){await t.isMapped(),T=[],t.map.TAGS&&(T=await t.map.TAGS.map(async e=>await(await t.meta.getColMeta(e))?.getChoices()??[]),T=await Promise.all(T))}function O(e){const a=document.createElement("div");a.className=`carte ${t.opt.rotation?"":" norotate"}${t.opt.compact?" compact":""}`,a.setAttribute("data-todo-id",e.id),a.setAttribute("data-last-update",e.DERNIERE_MISE_A_JOUR||""),a.setAttribute("data-deadline",e.DEADLINE||""),e.COULEUR&&t.col.COULEUR.type==="Choice"&&(t.col.COULEUR.getColor(e.COULEUR)?a.setAttribute("style",`background-color: ${t.col.COULEUR.getColor(e.COULEUR)}`):a.setAttribute("style",`background-color: ${(e.COULEUR.startsWith("#")?"":"#")+e.COULEUR}`));const n=e.TYPE||"",s=e.DESCRIPTION_DISPLAY||e.DESCRIPTION||u("No description"),o=e.DEADLINE?C(e.DEADLINE):"",i=Array.isArray(e.RESPONSABLE)?e.RESPONSABLE.filter(Boolean):e.RESPONSABLE?[e.RESPONSABLE]:[],r=i.map(p=>`
    <span class="responsable-badge">
      ${p}
    </span>
  `).join(""),l=e.REFERENCE_PROJET,E=e.TAGS||[];let d="";E.forEach(p=>d+=p?`<div class="more-tag">${p}</div>`:"");const c=t.getValueListOption("columns",e.STATUT);return a.innerHTML=`
    ${l&&l.length>0?`<div class="projet-ref truncate">#${l}</div>`:""}
    ${n?`<div class="type-tag truncate">${n}</div>`:l&&l.length>0?"<div>&nbsp;</div>":""}
    ${E.length>0?`<div>${d}</div>`:""}
    <div class="description">${s}</div>
    ${o?`<div class="deadline${e.DEADLINE<Date.now()?" late":""} truncate">📅 ${o}</div>`:i.length?"<div>&nbsp;</div>":""}
    ${i.length?`<div class="responsables-list">${r}</div>`:""}
    ${c?.isdone?`<div class="tampon-termine" style="color: ${t.col.STATUT.getColor(e.STATUT)??g};">${e.STATUT}</div>`:""}      
`,a.addEventListener("click",()=>{grist.setCursorPos({rowId:e.id}),t.opt.hideedit||S(e)}),a.addEventListener("dblclick",()=>{grist.setCursorPos({rowId:e.id}),t.opt.gristeditcard?grist.commandApi.run("viewAsCard"):t.opt.hideedit||S(e)}),a}async function A(e,a,n,s){try{if(s?.stopPropagation(),a==="STATUT"){const i=t.getValueListOption("columns",n);i&&i.useconfetti&&B()}let o={[a]:n||void 0};t.map.DERNIERE_MISE_A_JOUR&&(o.DERNIERE_MISE_A_JOUR=new Date().toISOString()),await t.updateRecords(t.formatRecord(e,o))}catch(o){console.error(u("Error during update:"),o)}}function D(e){const a=Array.from(e.children),n=e.dataset.isdone;a.sort((s,o)=>{let i=0;if(t.map.DEADLINE)if(n){const r=s.getAttribute("data-last-update")||"1970-01-01",l=o.getAttribute("data-last-update")||"1970-01-01";i=new Date(l)-new Date(r)}else{const r=s.getAttribute("data-deadline")||"9999-12-31",l=o.getAttribute("data-deadline")||"9999-12-31";i=new Date(r)-new Date(l)}if(i===0){const r=parseInt(s.getAttribute("data-todo-id"))||0,l=parseInt(o.getAttribute("data-todo-id"))||0;return r-l}else return i}),a.forEach(s=>e.appendChild(s))}function N(e){const a=e.querySelector(".contenu-colonne"),n=e.querySelector(".compteur-colonne");a&&n&&(n.textContent=`(${a.children.length})`)}function S(e){const a=document.getElementById("popup-todo"),n=document.querySelector(".carte.active"),s=document.querySelector(`[data-todo-id="${e.id}"]`),o=t.getValueListOption("columns",e.STATUT);if(t.opt.readonly){h();return}n?.classList.remove("active"),s?.classList.add("active"),a.style=`border-left-color: ${t.col.STATUT.getColor(e.STATUT)??g}`,a.dataset.statut=e.STATUT,a.dataset.isdone=o?!1:o.isdone,a.dataset.currentTodo=e.id;const i=a.querySelector(".popup-title"),r=a.querySelector(".popup-content"),l=a.querySelector(".popup-header");l.style=`background-color: ${t.col.STATUT.getColor(e.STATUT)??g};color:${t.col.STATUT.getTextColor(e.STATUT)??R}`;const E=a.querySelector(".bouton-fermer");E.style=`color:${t.col.STATUT.getTextColor(e.STATUT)??R}`,i.textContent=e.DESCRIPTION||u("New task");let d=1,c='<div class="field-row">';t.map.DEADLINE&&(c+=`
            <div class="field">
        ...
        `),t.map.REFERENCE_PROJET&&(c+=y(e.id,e.REFERENCE_PROJET,t.valuesList.ref,t.map.REFERENCE_PROJET,"REFERENCE_PROJET",t.col.REFERENCE_PROJET.getIsFormula()),d+=1),d%2===0&&(c+='</div><div class="field-row">'),t.map.TYPE&&(c+=y(e.id,e.TYPE,t.valuesList.types,t.map.TYPE,"TYPE",t.col.TYPE.getIsFormula()),d+=1),d%2===0&&(c+='</div><div class="field-row">'),t.map.RESPONSABLE&&(c+=U(e.id,e.RESPONSABLE,t.valuesList.incharge,t.map.RESPONSABLE,"RESPONSABLE",t.col.RESPONSABLE.getIsFormula()),d+=1),d%2===0&&(c+='</div><div class="field-row">'),t.map.TAGS&&t.map.TAGS.forEach((p,m)=>{c+=y(e.id,e.TAGS[m],T[m],p,p,t.col.TAGS[m].getIsFormula()),d+=1,d%2===0&&(c+='</div><div class="field-row">')}),t.map.COULEUR&&(c+=y(e.id,e.COULEUR,t.valuesList.cardcolor,t.map.COULEUR,"COULEUR"),t.col.COULEUR.getIsFormula(),d+=1),c+=`</div>
        <div class="field">
    ...
    `,t.map.NOTES&&(c+=`<div class="field">
        ...
        `),r.innerHTML=c,setTimeout(()=>{document.querySelectorAll(".auto-expand").forEach(m=>{m.style.height="",m.style.height=m.scrollHeight+"px"})},0),a.classList.add("visible")}function y(e,a,n,s,o,i){let r="";return n?.length>0?n.length<10?(r+=`
                <div class="field">
        ...
        `,r}function U(e,a,n,s,o,i){const r=new Set(Array.isArray(a)?a.map(String):a?[String(a)]:[]),l=(n||[]).filter(Boolean).map(E=>{const d=String(E),c=r.has(d)?"selected":"";return`
        <option value="${t.escapeQuotes(d)}" ${c}>
          ${d}
        </option>
      `}).join("");return`
    <div class="field">
  ...
  `}async function P(e,a,n,s){const o=Array.from(n.selectedOptions).map(i=>i.value).filter(Boolean);await A(e,a,o,s)}function h(){const e=document.getElementById("popup-todo"),a=e.dataset.currentTodo,n=document.querySelector(`[data-todo-id="${a}"]`);n&&n.classList.remove("active"),e.classList.remove("visible")}document.addEventListener("keydown",e=>{e.key==="Escape"&&h()}),document.addEventListener("click",e=>{const a=document.getElementById("popup-todo");a.classList.contains("visible")&&!a.querySelector(".popup-content").contains(e.target)&&!e.target.closest(".carte")&&!e.target.closest(".popup-header")&&h()});async function _(e){try{let a={DESCRIPTION:"",STATUT:e};t.map.TYPE&&!t.col.TYPE.getIsFormula()&&(a.TYPE=""),t.map.REFERENCE_PROJET&&!t.col.REFERENCE_PROJET.getIsFormula()&&(a.REFERENCE_PROJET=null),t.map.DERNIERE_MISE_A_JOUR&&!t.col.DERNIERE_MISE_A_JOUR.getIsFormula()&&(a.DERNIERE_MISE_A_JOUR=new Date().toISOString()),t.map.CREE_LE&&!t.col.CREE_LE.getIsFormula()&&(a.CREE_LE=new Date().toISOString()),t.map.RESPONSABLE&&!t.col.RESPONSABLE.getIsFormula()&&(a.RESPONSABLE=[]);const n=await t.createRecords({fields:a});if(n.id&&n.id>0){const s=await t.fetchSelectedRecord(n.id);grist.setCursorPos({rowId:n.id}),t.opt.hideedit||S(s)}}catch(a){console.error(u("Error on creation:"),a)}}async function k(e,a){if(a?.stopPropagation(),confirm(u("Are you sure you want to delete this task?")))try{await t.destroyRecords(e),h()}catch(n){console.error(u("Error on delete:"),n)}}function J(e,a){a?.stopPropagation(),e.classList.toggle("collapsed"),localStorage.setItem(`column-todo-${e.querySelector(".titre-statut").textContent.trim()}`,e.classList.contains("collapsed"))}function B(){const a=Date.now()+2e3,n={startVelocity:30,spread:360,ticks:60,zIndex:0};function s(i,r){return Math.random()*(r-i)+i}const o=setInterval(function(){const i=a-Date.now();if(i<=0)return clearInterval(o);const r=50*(i/2e3);confetti(Object.assign({},n,{particleCount:r,origin:{x:s(.1,.3),y:Math.random()-.2}})),confetti(Object.assign({},n,{particleCount:r,origin:{x:s(.7,.9),y:Math.random()-.2}}))},250)}function C(e){if(!e)return"-";const a=new Date(e);if(a>=f)return null;const n=a.getDate().toString().padStart(2,"0"),s=a.toLocaleDateString(t.cultureFull,{month:"short"}),o=a.getFullYear();return`${n} ${s} ${o}`}function x(e){if(!e)return"";try{const a=new Date(e);return a>=f?"":a.toISOString().split("T")[0]}catch(a){return console.error(u("Error on date formating:"),a),""}}window.toggleColonne=J,window.togglePopupTodo=S,window.fermerPopup=h,window.mettreAJourChamp=A,window.creerNouvelleTache=_,window.supprimerTodo=k,window.mettreAJourChampMultiple=P}));
